...
import { getActiveAds, getAllAds, createAd, updateAd, deleteAd, trackClick, toggleAllAds } from '../controllers/adController';
...
router.post('/:id/click', authenticate as any, trackClick as any);
...
router.post('/admin/toggle-all', authenticate as any, authorize('admin') as any, toggleAllAds as any);
