...
router.post('/:id/click', auth_1.authenticate, adController_1.trackClick);
// Admin routes
...
router.post('/admin/toggle-all', auth_1.authenticate, (0, auth_1.authorize)('admin'), adController_1.toggleAllAds);
